...
function SidebarSettingsShortcuts( editor ) {
	...
	const shortcuts = [ 'translate', 'rotate', 'scale', 'undo', 'focus', 'play animation' ];
	...
	document.addEventListener( 'keydown', function ( event ) {
		...
		switch ( event.key.toLowerCase() ) {
			...
			case config.getKey( 'settings/shortcuts/playAnimation' ):

				if (editor.action){
					let playAnimationBt = document.getElementById("playAnimationBt");
					playAnimationBt.click();
				}
