...
class UIPanelMovable extends UIDiv {
...
// <input type="range" min="0" max="10" step="1" value="0"><div className="value">0</div>
	...
	constructor( number ) {
		...
		function onInput(  ){
			...
			if ( scope.dom.value !== undefined ) {

				scope.value = scope.dom.value;
	...
	setStep(value){
		this.dom.setAttribute('step', value);
	}
...
class UIButton extends UIElement {
	...
	// Input: boolean
	setEnabled( value ){
		this.dom.disabled = value ? "" : "disabled";
	}
}
...
export { UIElement, UISpan, UIDiv, UIRow, UIPanel, UIPanelMovable,
			UIText, UIInput, UITextArea, UISelect, UICheckbox, UIColor, UINumber,
				UIInteger, UIBreak, UIHorizontalRule, UIButton, UIProgress, UITabbedPanel,
					UIListbox, ListboxItem, UISlider };
