...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		const { ColladaExporter } = await import( '../jsm/exporters/ColladaExporter.js' );
	...
	option.onClick( async function () {
		...
		const { DRACOExporter } = await import( '../jsm/exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		const { PLYExporter } = await import( '../jsm/exporters/PLYExporter.js' );
	...
	option.onClick( function () {
		...
		// Split into partial geometries and reunite
		console.log("output", output.scene);
