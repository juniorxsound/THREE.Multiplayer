function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'menubar/examples/Truck': 'Truck (2.5MB)',
			'menubar/examples/iBeam': 'iBeam (0.12MB)',
			'menubar/examples/FrontSuspension': 'Front Suspension (2.3MB)',
			'menubar/examples/Door_2_Flexibility': 'Door 2 Flexibility (0.06MB)',
			'menubar/examples/2CylindersEngine': '2 Cylinders Engine (5MB)',
			'menubar/examples/Lantern': 'Lantern (13MB)',
			'menubar/examples/ReciprocatingSaw': 'ReciprocatingSaw (12MB)',



			'menubar/view': 'View',
			'menubar/view/fullscreen': 'Fullscreen',
			'menubar/view/lightmode': 'Light mode',
			'menubar/view/darkmode': 'Dark mode',
			...
			'menubar/help/tips_for_performance': 'Tips for performance',

			'upperRibbon/results': 'Results',
			'upperRibbon/newFile': 'new File',
			...
			'sidebar/object/mergevertices': 'Merge Vertices',
			...
			'toolbar/homeInitialView': 'Isometric fit view',
			'toolbar/browserHierarchyView': 'Show/Hide browser',
			'toolbar/showHideBt': 'Show/Hide object',



			'toolbar/viewsBt': 'Save preview image',

			'toolbar/meshVisualization': 'Mesh Visualization',
			'toolbar/shadedElementsWithNoLines': 'Shaded Elements with no Lines',
			'toolbar/shadedElementsWithMeshLines': 'Shaded Elements with Meshlines',
			'toolbar/shadedElementsWithFeatureLines': 'Shaded Elements with Feature Lines',
			'toolbar/transparentElements': 'Transparent Elements',
			'toolbar/wireframeElements': 'Wireframe Elements',

			'toolbar/perspectiveBt': 'Switch to perspective projection',
			'toolbar/orthographicBt': 'Switch to orthographic projection',

			'toolbar/visibilityToggle': 'Toggle visibility',

			'toolbar/rotatePrincipal': 'Rotate to closest principal axis',
			'toolbar/fitSelected': 'Fit selected (f)',
			'toolbar/sliceBt': 'Add section cut',
			'toolbar/explodeBt': 'Explode view',

			'toolbar/results': 'Results',

			'toolbar/animationGoToStart': 'Go to start',
			'toolbar/playFrameBackwards': 'Single frame backward',
			'toolbar/playCircle': 'Play in a continuous loop / Pause',
			'toolbar/playFrameForwards': 'Single frame forwards',
			'toolbar/animationGoToEnd': 'Go to end',
			...
			'viewport/info/powerconsumption': 'Power'
